...
use IGFS_CG_API\Exception\ConnectionException;
use IGFS_CG_API\Exception\ReadWriteException;
use IGFS_CG_API\Exception\IgfsException;
use IGFS_CG_API\Exception\IgfsMissingParException;
use IGFS_CG_API\Exception\IOException;
...
abstract class BaseIgfsCg
{
    ...
    private static $version = "2.4.0.9";
    ...
    public function execute()
    {
        try {
            ...
            if ($e instanceof ConnectionException || $e instanceof ReadWriteException) {
